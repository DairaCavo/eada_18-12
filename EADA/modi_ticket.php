...
if (isset($_GET['id_ticket'])) {
    ...
    $sql = "SELECT id_ticket, titulo, fecha_asignacion, fecha_finalizacion, descripcion, prioridad, estado, paleta_colores,  esquema_diseño, comentarios_adicionales FROM tickets WHERE id_ticket = ?";
